                ...
                <div class="sidebar-item__content">
                    <ul class="sidebar-category">
                        @foreach($category as $array)
                            ...
                            {{--                                    {{ csrf_field()}}--}}
                            {{--                                    <input type="hidden" name="category" value="{{$array['0']}}">--}}
                            {{--                                    <input type="hidden" name="id" value="{{$array['1']}}">--}}
                            {{--                                    <button type="submit" class="sidebar-category__item">{{$array['0']}}--}}
                            {{--                                    </button>--}}
                            {{--                                </form>--}}
                            <li class="sidebar-category__item"><a
                                    href="{{route('orders',['category'=>$array['0'],'id'=>$array['1']])}}"
                                    class="sidebar-category__item__link">{{$array['0']}}</a></li>
                        @endforeach
                    </ul>
                </div>
            </div>
