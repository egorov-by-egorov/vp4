        ...
        <div class="content-middle">
            <div class="content-head__container">
                <div class="content-head__title-wrap">
                    <div class="content-head__title-wrap__title bcg-title">Игры в разделе {{$product}}</div>
                </div>
                    ...
                    @foreach($orders as $item)
                        <div class="products-category__list__item">
                            <div class="products-category__list__item__title-product"><a
                                    href="{{ route('product',['id'=>$item->id])}}">{{$item->title}}</a></div>
                            ...
                            <div class="products-category__list__item__description"><span
                                    ...
                                    href="{{route('buy',['id'=>$item->id])}}" class="btn btn-blue">Купить</a></div>
                        </div>
                    @endforeach
                </div>
                <ul class="page-nav">
